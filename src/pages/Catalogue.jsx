  ...
  return (
    <div className='space-y-10 mb-4'>
        <div className='ml-20 mt-14 text-md'>
            ...
            <h1 className='text-4xl font-semibold font-serif text-center mt-10 my-5 text-[#1c3755]'>CODING PATHSHALA BOOK CATALOGUE</h1>

            <hr className='w-[30%] m-auto mt-10'/>
            <p className='text-[#bc6c25] text-center text-2xl font-semibold font-mono mt-10'>Get Connected And Stay Connected</p>
            <hr className='w-[30%] m-auto mt-10'/>
            <p className='text-center text-gray-400 text-lg font-mono font-semibold my-5'>Dear visitor your requirments/suggetions are important to us. <br /> Please feel free to call us on below number and ask for the respective extentions</p>
            <p className='text-center text-[#af7352] font-bold text-xl m-auto my-7 w-[10%]'>05624308606</p>


        <div className='flex justify-around'>
            <div className='text-center border-2 border-gray-200 w-[20%] py-10 bg-[#f2e9e4] hover:shadow-lg hover:shadow-[#83492a] rounded'>
        ...
        <div className='flex justify-around'>
            ...
            <div className='text-center border-2 border-gray-200 w-[20%] py-10 bg-[#f2e9e4] hover:shadow-lg hover:shadow-[#83492a] rounded'>
                <img src="ssc (1).png" className='m-auto' />
                <hr className='w-[90%] mt-5 m-auto mb-5'/>
