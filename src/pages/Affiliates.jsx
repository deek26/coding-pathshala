  ...
  return (
    <div>
      <div className='ml-20 mt-14 text-md'>
        ...
        <h1 className='text-center font-serif font-semibold text-4xl text-[#725138] my-4'>Influence The Students</h1>
       ...
       <p className='text-center font-serif font-semibold text-lg text-[#a09963] my-4'>For Collaborations, Reach Out To Us : </p>
